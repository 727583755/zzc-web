...
<html>
	...
	<body>
		<div class="container">
			<div class="row">
				<button type="button" class="btn btn-success" onclick="location='${WEB_ROOT_PATH}/admin/story/add'">新增</button>
			</div>
		</div>

		<div class="container">
			<div class="row">
				<form class="form-inline" action="${WEB_ROOT_PATH}/admin/story" method="post">
		...
		<div class="container">
			...
			<@pager url="${WEB_ROOT_PATH}/admin/story" data=data/>
